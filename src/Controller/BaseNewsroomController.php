...
/**
 * BaseNewsroomController class.
 */
abstract class BaseNewsroomController extends ControllerBase {
  ...
  public function import($newsroom_id) {
    $this->newsroomProcessorPluginManager->createInstance($this->getPluginId())->import($newsroom_id);
    $this->redirectItem($newsroom_id);
  }

  public function redirectItem($newsroom_id) {
    $this->newsroomProcessorPluginManager->createInstance($this->getPluginId())->redirect($newsroom_id);
  }
