...
namespace Drupal\nexteuropa_newsroom_topic\Controller;
...
/**
 * NexteuropaNewsroomTopicController class.
 */
class NexteuropaNewsroomTopicController extends ControllerBase {
  ...
  public function import($newsroom_id) {
    $this->newsroomProcessorPluginManager->createInstance('newsroom_topic')->import($newsroom_id);
    $this->redirectItem($newsroom_id);
  }

  public function redirectItem($newsroom_id) {
    $this->newsroomProcessorPluginManager->createInstance('newsroom_topic')->redirect($newsroom_id);
  }
