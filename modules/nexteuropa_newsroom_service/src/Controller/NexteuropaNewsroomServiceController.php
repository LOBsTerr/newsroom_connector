...
namespace Drupal\nexteuropa_newsroom_service\Controller;
...
/**
 * NexteuropaNewsroomServiceController class.
 */
class NexteuropaNewsroomServiceController extends ControllerBase {
  ...
  public function import($newsroom_id) {
    $this->newsroomProcessorPluginManager->createInstance('newsroom_service')->import($newsroom_id);
    $this->redirectItem($newsroom_id);
  }

  public function redirectItem($newsroom_id) {
    $this->newsroomProcessorPluginManager->createInstance('newsroom_service')->redirect($newsroom_id);
  }
